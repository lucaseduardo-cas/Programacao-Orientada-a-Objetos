...
a->fazerSom();  // Vai chamar "Cachorro late" são SE a função for virtual

Se a função não for virtual, o C++ chama a versÃ£o da classe base (Animal), mesmo que o objeto real seja um Cachorro.
