...
que vão manipular os atributos. Ou seja, definir uma classe com 2 métodos e 2 atributos. Além disso, 
...
int main () {
    ...
    // Chamando o método público, função exibirSO e exibirProcessador
