/*
Tarefa 25/02/2025: Construa um tipo abstrato de dados que contenha pelo menos 2 atributos e 2 métodos que vÃ£o 
...
int main() {
    ...
    std::getline(std::cin, nome);  // LÃª o nome completo

    std::cout << "Digite a idade: ";
    std::cin >> idade; // LÃª a idade

    // Definindo os dados da pessoa
    p1.definirDados(nome, idade);

    // Exibindo os dados da pessoa
    std::cout << "\nInformaÃ§Ãµes da pessoa:" << std::endl;
    p1.mostrarDados();
